...
if(isset($_GET['logout']) && $_GET['logout'] == true){
    $message = "";
        ...
        if ($email == "allyzanerias@gmail.com" && $password == "ally") {
...
body {
    ...
    background-color: #b0e0e6; /* Baby Blue background */
...
.card-header, .card-footer {
    background-color: #87cefa; /* Slightly lighter Baby Blue for card header and footer */
    color: #000000; 
